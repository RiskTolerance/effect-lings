...
section(
	'acquireRelease pairs setup with guaranteed cleanup. Inside a scope, release runs when the scope closes — even on failure.'
)
...
check(
	'acquire runs, then use, then release fires automatically on scope close',
	log,
	['open', 'use', 'close']
)
