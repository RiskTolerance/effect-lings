...
section(
	'Mutable state, the Effect way: a Ref is a typed, fiber-safe cell you read and update with Effects.'
)
...
// ---- checks (don't edit) ----
check(
	'update threads state through the program',
	Effect.runSync(program),
	7
)
check(
	'modify returns the old value while updating the cell',
	Effect.runSync(drawThenAdd),
	100
)
