...
//   https://effect-ts.github.io/effect/effect/Effect.ts.html#fail
//   https://effect-ts.github.io/effect/effect/Effect.ts.html#catchtag
//   https://effect-ts.github.io/effect/effect/Data.ts.html#taggederror
//   Concept docs: https://effect.website/docs/error-management/expected-errors/#catchtag
...
const ensurePositive = (n: number): Effect.Effect<number, TooSmall> => {
  if (n > 0) {
    ...
    return Effect.fail(new TooSmall({ value: n }))
  }
}
...
const recovered = ensurePositive(-3).pipe(Effect.catchTag("TooSmall", (e) => {
  return Effect.succeed(`too small: ${e.value}`)
